...
//go:embed zcopilot_1.0.80_linux_arm64.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.80_linux_arm64.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.80",
		CliHash: mustDecodeBase64("6j81uZdiqcd8kTHnmlaJIj7SUBL3fu0WX97xkKDi6nM="),
	})
}
