...
//go:embed zcopilot_1.0.80_darwin_arm64.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.80_darwin_arm64.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.80",
		CliHash: mustDecodeBase64("/nedp90jQsHSPwdEhz+ifQJR6q7k3GY3+lMJNjnA88k="),
	})
}
