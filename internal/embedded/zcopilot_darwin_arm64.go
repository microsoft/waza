...
//go:embed zcopilot_1.0.46_darwin_arm64.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.46_darwin_arm64.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.46",
		CliHash: mustDecodeBase64("MnWjNt1g5HzW6GJgctdEKyjJ2giwCkOQDCAnI6WIPhg="),
	})
}
