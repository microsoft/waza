...
//go:embed zcopilot_1.0.80_windows_arm64.exe.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.80_windows_arm64.exe.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.80",
		CliHash: mustDecodeBase64("CzdhnS+nm8OR6w8nsylLMBUVaiMo8sKVC1qtHzkYrlM="),
	})
}
