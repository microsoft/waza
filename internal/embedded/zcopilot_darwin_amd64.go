...
//go:embed zcopilot_1.0.80_darwin_amd64.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.80_darwin_amd64.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.80",
		CliHash: mustDecodeBase64("FaJXZWZjX90twMhBN+x0geQaaYIoE5HGLliIOqXzn0E="),
	})
}
