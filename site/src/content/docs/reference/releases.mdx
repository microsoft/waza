...
## Previous highlighted release: v0.38.1
...
- **JSON schema output extraction** — `json_schema` supports `extract_json: true` to validate a single JSON document wrapped in prose or a Markdown JSON code block while preserving strict validation by default.
...
## Previous highlighted release: v0.38.0
...
|----------|-------------|----------|
| macOS | Apple Silicon (ARM64) | [waza-darwin-arm64](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-darwin-arm64) |
| macOS | Intel (AMD64) | [waza-darwin-amd64](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-darwin-amd64) |
| Linux | x64 (AMD64) | [waza-linux-amd64](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-linux-amd64) |
| Linux | ARM64 | [waza-linux-arm64](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-linux-arm64) |
| Windows | x64 (AMD64) | [waza-windows-amd64.exe](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-windows-amd64.exe) |
| Windows | ARM64 | [waza-windows-arm64.exe](https://github.com/microsoft/waza/releases/download/v0.38.2/waza-windows-arm64.exe) |
...
azd extension install azd-waza \
  --source https://github.com/microsoft/waza/releases/download/azd-ext-microsoft-azd-waza_0.38.2/azd-ext-microsoft-azd-waza_0.38.2.tar.gz
```
