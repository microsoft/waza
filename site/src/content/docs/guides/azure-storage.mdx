...
Waza pins Azure Blob requests, including retries, to service version `2026-10-06`.
This follows the [azblob v1.8.1 release guidance](https://github.com/Azure/azure-sdk-for-go/releases/tag/sdk/storage/azblob/v1.8.1)
to avoid `400 InvalidHeaderValue` errors while the SDK's default `2026-12-06` version
rolls out. No user configuration is required; the pin should only be removed after
rollout completion is verified.
