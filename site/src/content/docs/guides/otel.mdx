...
content from spans — only the SHA-256 digest and byte length are recorded. This
keeps user prompts and tool outputs out of your trace backend.
...
When enabled, the following attributes carry full content:
